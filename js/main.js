...
$(document).ready(function () {
  var table = $('#compass').DataTable({
    "dom": '<"toptools"><"toolbar"><"pillFilter"><l>t<lpi>',
    lengthMenu: [
      [ 5, 10, 25, 50, -1 ],
  ...
  $('.pillFilter').html('<div class="pillFilter"><button type="button" class="btn btn-labeled btn-primary">Federal<span class="btn-label"><i class="fas fa-times text-white"></i></span></button></div>');
